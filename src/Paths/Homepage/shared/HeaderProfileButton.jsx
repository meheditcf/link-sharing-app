import LogoProfile from "../../../assets/images/icon-profile-details-header.svg";
...
const HeaderProfileButton = ({isImageLarge, handleClick, selectedIcon}) => {
    return (
        <StyledProfileButton className={`${selectedIcon === "LogoProfile" ? "active" : ""}`} onClick={() => {
            handleClick("LogoProfile", "Profile")
        }}>
            <img src={LogoProfile} className={`header--logo`}/>
