...
import LogoArrowDown from "../../../assets/images/icon-chevron-down.svg";
...
const LinkComponent = ({id, platform, removeLink}) => {
    const [platformLogo, setPlatformLogo] = useState(<img src={LogoGitHub}/>)
        ...
        <StyledLinkContainer>
            ...
            <div className="link--form">
                ...
                <div className="platform" name="platform" id="platform" tabIndex="1" onClick={handleClickDropDown}>
                    ...
                    <p>{selectedOption}</p>
                    <div className={"arrow--logo"}><img src={LogoArrowDown}
                                                        className={`${dropDownActive ? "rotate" : "rotateback"}`}/>
                    </div>
                </div>
